...
public class Updater
{
    ...
    private IUpdateReceiver updateReceiver;
    ...
    public Updater(Plugin plugin, int id, File file, UpdateType updateType, boolean logger, IUpdateReceiver updateReceiver)
    {
        this.plugin = plugin;
    ...
    private void download()
    {
        ...
        catch (Exception e)
        {
            ...
            this.updateReceiver.setUpdateInstalled(version);
        }
    }
